        ...
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm font-light leading-relaxed text-white/55">
              {ASTRO.subheading} A {ASTRO.durationLabel.toLowerCase()} astrophotography expedition
              across {ASTRO.region} by {ASTRO_CONTACT.brand}, India’s leading experiential astronomy
              ecosystem.
            </p>
            <a
            ...
            >
              Reserve Your Seat <ArrowUpRight size={15} />
            </a>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-white/65">
              ...
              <li><a href="#trainer" className="transition-colors hover:text-white">Trainer</a></li>
              <li><a href="#learn" className="transition-colors hover:text-white">What You’ll Learn</a></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-white/65">
              <li>
                <a href={`tel:${ASTRO_CONTACT.phone.replace(/\s/g, '')}`} className="inline-flex items-center gap-2 transition-colors hover:text-white">
                  <Phone size={14} className="text-[var(--av-gold)]" /> {ASTRO_CONTACT.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${ASTRO_CONTACT.email}`} className="inline-flex items-center gap-2 transition-colors hover:text-white">
                  <Mail size={14} className="text-[var(--av-gold)]" /> {ASTRO_CONTACT.email}
                </a>
              </li>
